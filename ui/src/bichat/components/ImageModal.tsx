        ...
        >
          ...
          {!isImageLoaded && !imageError && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-xs text-gray-400 dark:text-gray-500">{t('BiChat.Loading')}</span>
              </div>
            </div>
          )}
          ...
          {imageError && (
            <div role="alert" className="flex flex-col items-center justify-center text-center max-w-xs">
              ...
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('BiChat.Image.FailedToLoad')}</p>
