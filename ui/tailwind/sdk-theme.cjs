/** @type {Record<string, unknown>} Theme extension for Tailwind (oklch design tokens from iota.css). */
module.exports = {
  fontFamily: {
    sans: ["Gilroy"],
  },
  ...
  // Colors with " / <alpha-value>" support opacity modifiers (e.g. bg-brand/50).
  colors: {
    100: "oklch(var(--clr-text-100) / <alpha-value>)",
    200: "oklch(var(--clr-text-200) / <alpha-value>)",
    300: "oklch(var(--clr-text-300) / <alpha-value>)",
    pink: "oklch(var(--clr-text-pink) / <alpha-value>)",
    yellow: "oklch(var(--clr-text-yellow) / <alpha-value>)",
    blue: "oklch(var(--clr-text-blue) / <alpha-value>)",
    purple: "oklch(var(--clr-text-purple) / <alpha-value>)",
    avatar: "oklch(var(--clr-avatar-text) / <alpha-value>)",
    black: {
    ...
    green: {
      DEFAULT: "oklch(var(--clr-text-green) / <alpha-value>)",
    ...
    badge: {
      pink: "oklch(var(--clr-badge-pink) / <alpha-value>)",
      yellow: "oklch(var(--clr-badge-yellow) / <alpha-value>)",
      green: "oklch(var(--clr-badge-green) / <alpha-value>)",
      blue: "oklch(var(--clr-badge-blue) / <alpha-value>)",
      purple: "oklch(var(--clr-badge-purple) / <alpha-value>)",
      gray: "oklch(var(--clr-badge-gray) / <alpha-value>)",
    },
    success: {
